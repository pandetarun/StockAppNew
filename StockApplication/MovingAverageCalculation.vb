...
Public Class MovingAverageCalculation
    Dim lastTradedPrice, threeSampleSMA, fiveSampleSMA, tenSampleSMA, fifteenSampleSMA, twentySampleSMA, FiftySampleSMA, TwoHundredMA, simpleMA As Double
    Dim threeSampleEMA, fiveSampleEMA, tenSampleEMA, fifteenSampleEMA, twentySampleEMA, FiftySampleEMA, TwoHundredEMA As Double
    ...
    Private Function GetStockListAndCalculateIntraDayMA() As Boolean
        ...
        StockAppLogger.Log("GetStockListAndCalculateIntraDayMA Start", "MovingAverageCalculation")
        Try
            ...
            While ds.Read()
                ...
                If Not tmpStockList.Contains(tmpStockCode) Then
                    ...
                    Else
                        StockAppLogger.Log("GetStockListAndCalculateIntraDayMA IntraDayMACalcultaion failed for Stock = " & tmpStockCode & " at time = " & MATime, "MovingAverageCalculation")
                    End If
                End If
            End While
        ...
        Catch exc As Exception
            ...
            Return False
        End Try
        StockAppLogger.Log("GetStockListAndCalculateIntraDayMA End", "MovingAverageCalculation")
        Return True
    End Function
    ...
    Private Function IntraDayMACalculation(tmpStockCode As String) As Boolean
        ...
        StockAppLogger.Log("IntraDayMACalculation Start", "MovingAverageCalculation")
        ...
        Try
            ...
            End If
        Catch exc As Exception
            StockAppLogger.LogError("Error Occurred in calculating intraday moving average = ", exc, "MovingAverageCalculation")
            Return False
        End Try
        StockAppLogger.Log("IntraDayMACalculation End", "MovingAverageCalculation")
        Return True
    End Function
    ...
    Private Function InsertIntraDayMAtoDB() As Boolean
        ...
        StockAppLogger.Log("InsertIntraDayMAtoDB Start", "MovingAverageCalculation")
        ...
        If fifteenSampleSMA <> 0 Then
            ...
            insertValues = insertValues & ", " & fifteenSampleSMA
            fireQuery = True
        End If
        ...
        If fifteenSampleEMA <> 0 Then
            ...
            insertValues = insertValues & ", " & fifteenSampleEMA
            fireQuery = True
        End If
        ...
        Else
            StockAppLogger.Log("InsertIntraDayMAtoDB Insert Query not fired for stock = " & MAStock & " at time = " & MATime, "MovingAverageCalculation")
        End If
        StockAppLogger.Log("InsertIntraDayMAtoDB End", "MovingAverageCalculation")
        Return True
    End Function
    ...
    Private Function DailyMACalculation(tmpStockCode As String) As Boolean
        ...
        Try
            ...
            End If
        Catch exc As Exception
            StockAppLogger.LogError("Error Occurred in calculating daily MA data = ", exc, "MovingAverageCalculation")
            Return False
        End Try
        StockAppLogger.Log("DailyMACalculation End", "MovingAverageCalculation")
        Return True
    End Function
    ...
    Private Function InsertDailyMAtoDB() As Boolean
        ...
        StockAppLogger.Log("InsertDailyMAtoDB Start", "MovingAverageCalculation")
        ...
        If fireQuery Then
            DBFunctions.ExecuteSQLStmt(sqlStatement)
        Else
            StockAppLogger.Log("InsertDailyMAtoDB Insert Query not fired for stock = " & MAStock & " at Date = " & MADate, "MovingAverageCalculation")
        End If
        StockAppLogger.Log("InsertDailyMAtoDB End", "MovingAverageCalculation")
        Return True
    End Function
